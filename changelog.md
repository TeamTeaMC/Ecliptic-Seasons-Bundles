...
The pack introduces additional seasonal rules, textures, and plant behavior definitions to improve how BWG vegetation
responds to the seasonal system.

Main additions include:

* New **season definitions** for multiple BWG plants and leaves, including:

    * Baobab
    * Barrel Cactus
    * Holly
    * Jacaranda / Indigo Jacaranda
    * Ironwood
    * Orchard trees
    * Skyris
    * Yucca
...
* Seasonal **leaf color transitions** and vegetation state rules.
